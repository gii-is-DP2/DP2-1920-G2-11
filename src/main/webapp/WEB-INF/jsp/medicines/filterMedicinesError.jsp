...
<petclinic:layout pageName="medicinesError">
    <h2>Medicines</h2>
   ...
   <p>Esta combinación no existe en el servidor. Elija otra diferente</p>
   <spring:url value="/owner/medicines/" var="medicinesUrl">      
   </spring:url>
   <p>A continuación se muestra la lista completa.</p>
