...
INSERT INTO products(id,name,description,price,stock, product_type_id) VALUES (1,'chámpu hidratante','para pelo seco',4.00,3,1);
INSERT INTO products(id,name,description,price,stock, product_type_id) VALUES (2,'Limpiador bucal','contiene láminas masticables para mantener limpia la dentadura del perro',8.00,100,1);
INSERT INTO products(id,name,description,price,stock, product_type_id) VALUES (3,'Limpiador bucal','contiene láminas masticables para mantener limpia la dentadura del perro',8.00,100,1);
INSERT INTO products(id,name,description,price,stock, product_type_id) VALUES (4,'champú para gato','',20.00,1,1);
INSERT INTO products(id,name,description,price,stock, product_type_id) VALUES (5,'chámpu hidratante','para pelo seco',4.00,34,1);
INSERT INTO products(id,name,description,price,stock, product_type_id) VALUES (6,'chámpu hidratante','para pelo seco',4.00,39,1);
INSERT INTO products(id,name,description,price,stock, product_type_id) VALUES (7,'cepillo','para peinar a perros y gatos.',5.00,30,1);
INSERT INTO products(id,name,description,price,stock, product_type_id) VALUES (8,'Stomodine 30 mls.','Stomodine gel para perros y gatos.Limpieza bucal, reduce la formación de placa y sarro. Infecciones cavidad bucal.',6.00,48,1);
INSERT INTO products(id,name,description,price,stock, product_type_id) VALUES (9,'chámpu hidratante','para pelo seco',4.00,3,1);
INSERT INTO products(id,name,description,price,stock, product_type_id) VALUES (10,'chámpu hidratante','para pelo seco',4.00,3,1);
INSERT INTO products(id,name,description,price,stock, product_type_id) VALUES (11,'chámpu hidratante','para pelo seco',4.00,3,1);
INSERT INTO products(id,name,description,price,stock, product_type_id) VALUES (12,'chámpu hidratante','para pelo seco',4.00,3,1);
INSERT INTO products(id,name,description,price,stock, product_type_id) VALUES (13,'','',1.00,1,1);
