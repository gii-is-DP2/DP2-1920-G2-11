...
public class HU18UITest {
	...
	@Test
	public void testPruebaCasoPositivoAdminMedicinesList() throws Exception {
		this.as("admin1").whenIamLoggedIntheSystemAsAdmin().thenICanListAdminMedicines();
	}
	...
	private void thenICanListAdminMedicines() {
