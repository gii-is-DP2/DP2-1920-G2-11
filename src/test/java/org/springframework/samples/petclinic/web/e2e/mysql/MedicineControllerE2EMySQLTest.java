...
public class MedicineControllerE2EMySQLTest {
	...
	void testShowMedicine() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/owner/medicine/{medicineId}", MedicineControllerE2EMySQLTest.TEST_MEDICINE_ID)).andExpect(MockMvcResultMatchers.status().isOk())
	...
	@Test
		void testShowMedicineError() throws Exception {
			this.mockMvc.perform(MockMvcRequestBuilders.get("/owner/medicine/{medicineId}", MedicineControllerE2EMySQLTest.TEST_MEDICINE_ERROR_ID)).andExpect(MockMvcResultMatchers.status().isOk())
	...
	@Test
		void testShowMedicineBySicknessAndPetTypeId() throws Exception {
			...
			params.add("petTypeId", Integer.toString(MedicineControllerE2EMySQLTest.TEST_PETTYPE_ID));
			params.add("sicknessId", Integer.toString(MedicineControllerE2EMySQLTest.TEST_SICKNESS_ID));
	...
	@Test
		void testShowMedicineBySicknessAndPetTypeIdError() throws Exception {
			MultiValueMap<String, String> params = new LinkedMultiValueMap<String,String>();
			params.add("petTypeId", Integer.toString(MedicineControllerE2EMySQLTest.TEST_PETTYPE_ERROR_ID));
			params.add("sicknessId", Integer.toString(MedicineControllerE2EMySQLTest.TEST_SICKNESS_ERROR_ID));
