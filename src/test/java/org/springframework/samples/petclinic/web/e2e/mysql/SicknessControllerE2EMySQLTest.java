...
public class SicknessControllerE2EMySQLTest {
	...
	void testShowSicknessesListHtml() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/owners/*/pets/{petId}/sicknesses", SicknessControllerE2EMySQLTest.TEST_PET_ID)).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.model().attributeExists("sicknesses"))
	...
	void testShowSicknessesErrorHtml() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/owners/*/pets/{petId}/sicknesses", SicknessControllerE2EMySQLTest.TEST_PET_ERROR_ID)).andExpect(MockMvcResultMatchers.status().isOk())
	...
	void testShowSicknessesShowHtml() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/owners/*/pets/{petId}/sicknesses/{sicknessId}", SicknessControllerE2EMySQLTest.TEST_PET_ID, SicknessControllerE2EMySQLTest.TEST_SICKNESS_ID)).andExpect(MockMvcResultMatchers.status().isOk())
	...
	void testShowSicknessesShowErrorHtml() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/owners/*/pets/{petId}/sicknesses/{sicknessId}", SicknessControllerE2EMySQLTest.TEST_PET_SHOW_ERROR_ID, SicknessControllerE2EMySQLTest.TEST_SICKNESS_ERROR_ID)).andExpect(MockMvcResultMatchers.status().isOk())
	...
	void testDeleteSicknessWithVacccine() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/owners/*/pets/{petId}/sicknesses/delete/{sicknessId}", SicknessControllerE2EMySQLTest.TEST_PET_ID, SicknessControllerE2EMySQLTest.TEST_SICKNESS_ID)).andExpect(MockMvcResultMatchers.status().is2xxSuccessful())
