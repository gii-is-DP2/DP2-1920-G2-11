...
public class VaccineControllerE2EMySQLTest {
	...
	void testShowVaccineListHtml() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.get("/owners/*/pets/{petId}/sicknesses/{sicknessId}/vaccines",
						VaccineControllerE2EMySQLTest.TEST_PET_ID, VaccineControllerE2EMySQLTest.TEST_SICKNESS_ID))
	...
	void testShowVaccineErrorHtml() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.get("/owners/*/pets/{petId}/sicknesses/{sicknessId}/vaccines",
						VaccineControllerE2EMySQLTest.TEST_PET_ERROR_ID, VaccineControllerE2EMySQLTest.TEST_SICKNESS_ERROR_ID))
				.andExpect(MockMvcResultMatchers.status().isOk())
	...
	void testShowVaccineShowHtml() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.get(
						...
						VaccineControllerE2EMySQLTest.TEST_PET_ID, VaccineControllerE2EMySQLTest.TEST_SICKNESS_ID,
						VaccineControllerE2EMySQLTest.TEST_VACCINE_ID))
				.andExpect(MockMvcResultMatchers.status().isOk())
	...
	void testShowVaccineShowErrorHtml() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.get(
						"/owners/*/pets/{petId}/sicknesses/{sicknessId}/vaccines/{vaccineId}",
						VaccineControllerE2EMySQLTest.TEST_PET_SHOW_ERROR_ID, VaccineControllerE2EMySQLTest.TEST_SICKNESS_SHOW_ERROR_ID,
						VaccineControllerE2EMySQLTest.TEST_VACCINE_ERROR_ID))
				.andExpect(MockMvcResultMatchers.status().isOk())
